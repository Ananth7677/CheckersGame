...
public class Checkers extends JPanel {
    ...
    public Checkers() {
        ...
        // try {
        //     Board asboard = new Board();
        // } catch (Exception e) {
        //     e.printStackTrace();
        //     System.out.println("Error initializing the board: " + e.getMessage());
        // }
...
//        private void GiveSequentialJumps(int index){
//            for (int i = 0; i < legalMoves.length; i++){
//                if(i == index){
//                    continue;
//                }
//
//                if(legalMoves[index].rows.get(0) == legalMoves[i].rows.get(1) && legalMoves[index].cols.get(0) == legalMoves[i].cols.get(1)){
//                    legalMoves[index].addMove(legalMoves[i].rows, legalMoves[i].cols);
//                }
//            }
//        }
